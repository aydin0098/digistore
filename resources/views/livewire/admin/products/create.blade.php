                ...
                <div class="col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <select wire:model="warranty_id" class="js-example-basic-single form-control" name="" style="width: 100%;">
                        ...
                        <div class="row">
                            <div class="form-group col-3 mt-20">
                                ...
                                <select wire:model="level1_id" class="js-example-basic-single form-control" name="" style="width: 100%;">
                            ...
                            <div class="form-group col-3 mt-20">
                                ...
                                <select wire:model="level2_id" class="js-example-basic-single form-control" name="" style="width: 100%;">
                                    @foreach($sub as $s)
                            ...
                            <div class="form-group col-3 mt-20">
                                ...
                                <select wire:model="level3_id" class="js-example-basic-single form-control" name="" style="width: 100%;">
                                    @foreach($child as $c)
                            ...
                            <div class="form-group col-3 mt-20">
                                ...
                                <select wire:model="brand_id" class="js-example-basic-single form-control" name="" style="width: 100%;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea wire:model="product.body" class="form-control" rows="10" id="body"></textarea>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-1 mt-20 form-group ">
                                <div class="custom-control custom-checkbox mr-sm-2 form-group" style="margin-top: 30px">
                                    <input wire:model="product.isActive" type="checkbox" class="custom-control-input" checked id="checkbox2" value="check">
                            ...
                            <div class="col-2 mt-20 form-group ">
                                <div class="custom-control custom-checkbox mr-sm-2" style="margin-top: 30px">
                                    <input wire:model="product.special" type="checkbox" class="custom-control-input" id="checkbox1" value="check">
