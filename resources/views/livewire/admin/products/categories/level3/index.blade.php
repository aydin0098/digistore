...
<div style="width: 100%;" class="row">
    <div class="col-xl-4 box-margin">
        <div class="card card-body">
            <div class="row">
                <a href="{{route('admin.categories.index')}}" class="btn btn-info col-6"
    ...
    <div class="col-12 col-lg-8 box-margin" wire:init="loadLogo">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-2">لیست دسته های سطح 3</h4>
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a href="{{route('admin.categories.level3.edit',$category->id)}}"
                                           class="action-icon"> <i
