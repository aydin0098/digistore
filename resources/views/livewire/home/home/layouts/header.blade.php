    ...
    <header class="header-main-page">
                        ...
                        <div class="col-lg-8 col-md-12 col-xs-12 pull-right">
                            <div class="search-header search-box">
                                <form action="#">
                                    ...
                                    <button class="btn-search" type="submit"><img src="{{asset('home/assets/images/search.png')}}"
                                            alt="search"></button>
                                </form>
                                <div class="search-result">
                                    ...
                                    <div class="search-results-list js-search-ad-banner">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/banner-search.jpg')}}" alt="banner-search">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <li class="js-mini-cart-item">
                                                    <a href="#" class="header-basket-list-item">
                                                        <div class="header-basket-list-item-image">
                                                            <img src="{{asset('home/assets/images/product-slider-2/GalaxyS20Ultra.jpg')}}"
                                                                alt="img-slider">
                                                        </div>
                                    ...
                                    <div class="header-profile-dropdown-account">
                                        <div class="header-profile-dropdown-user">
                                            <div class="header-profile-dropdown-user-img">
                                                <img src="{{asset('home/assets/images/svg/user-profile.svg')}}" alt="profile">
                                            </div>
        ...
        <nav class="sidebar">
            <div class="nav-header">
                ...
                <div class="logo-wrap">
                    <a class="logo-icon" href="#"><img alt="logo-icon" src="{{asset('home/assets/images/logo.png')}}" width="40"></a>
                </div>
            </div>
