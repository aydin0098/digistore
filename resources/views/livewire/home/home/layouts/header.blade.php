<header class="header-main-page">
        ...
        <div>
            <div class="col-lg-8 col-md-8 col-xs-12 pull-right">
                <div class="header-right">
                    <div class="logo">
                        <a href="#"><img src="{{asset('home/assets/images/logo.png')}}" alt="logo"></a>
                    </div>
                        ...
                        <div class="search-header search-box">
                            <form action="#">
                                ...
                                <button class="btn-search" type="submit"><img
                                        src="{{asset('home/assets/images/search.png')}}"
                                        alt="search"></button>
                            </form>
                            <div class="search-result">
                                ...
                                <div class="search-results-list js-search-ad-banner">
                                    <a href="#">
                                        <img src="{{asset('home/assets/images/banner-search.jpg')}}"
                                             alt="banner-search">
                                    </a>
                                </div>
                            </div>
            ...
            <div class="col-lg-4 col-md-4 col-xs-12 pull-left">
                <div class="header-left">
                                    ...
                                    <div class="force-overflow">
                                        <ul class="header-basket-list">
                                            <li class="js-mini-cart-item">
                                                <a href="#" class="header-basket-list-item">
                                                    <div class="header-basket-list-item-image">
                                                        <img
                                                            src="{{asset('home/assets/images/product-slider-2/GalaxyS20Ultra.jpg')}}"
                                                            alt="img-slider">
                                                    </div>
                                            ...
                                            <li class="js-mini-cart-item">
                                                <a href="#" class="header-basket-list-item">
                                                    <div class="header-basket-list-item-image">
                                                        <img src="{{asset('home/assets/images/product-slider-2/Huawei-WATCHFIT.jpg')}}"
                                                             alt="img-slider">
                                                    </div>
                                                    <div class="header-basket-list-item-content">
                                            ...
                                            <li class="js-mini-cart-item">
                                                <a href="#" class="header-basket-list-item">
                                                    <div class="header-basket-list-item-image">
                                                        <img src="{{asset('home/assets/images/product-slider-2/NIGHT-HUNTER.jpg')}}"
                                                             alt="img-slider">
                                                    </div>
                                                    <div class="header-basket-list-item-content">
                    ...
                    <div class="btn-login">
                            ...
                            <div class="dropdown-menu-login">
                                ...
                                <div class="header-profile-dropdown-actions">
                                    ...
                                    <div class="header-profile-dropdown-action-container">
                                             ...
                                             <span wire:click="logout({{$user->id}})" class="header-profile-dropdown-action-link">خروج از حساب کاربری</span>
                        ...
                        @endauth
                        @guest
                            <a href="{{route('login')}}" style="color: #3f3f3f">
                                <span class="mdi mdi-account"></span>
                                ورود به پنل کاربری
                            </a>
                        @endguest
                        ...
                        <div class="btn-login-responsive">
                            ...
                            <div class="dropdown-menu-login">
                                <div class="header-profile-dropdown-account">
                                    <div class="header-profile-dropdown-user">
                                        <div class="header-profile-dropdown-user-img">
                                            <img src="{{asset('home/assets/images/svg/user-profile.svg')}}"
                                                 alt="profile">
                                        </div>
                                        <div class="header-profile-dropdown-user-info">
                                            ...
                                            <ul class="header-basket-list">
                                                ...
                                                <li class="js-mini-cart-item">
                                                    <a href="#" class="header-basket-list-item">
                                                        <div class="header-basket-list-item-image">
                                                            <img
                                                                src="{{asset('home/assets/images/product-slider-2/Huawei-WATCHFIT.jpg')}}"
                                                                alt="img-slider">
                                                        </div>
                                                        <div class="header-basket-list-item-content">
                                                ...
                                                <li class="js-mini-cart-item">
                                                    <a href="#" class="header-basket-list-item">
                                                        <div class="header-basket-list-item-image">
                                                            <img
                                                                src="{{asset('home/assets/images/product-slider-2/NIGHT-HUNTER.jpg')}}"
                                                                alt="img-slider">
                                                        </div>
                                                        <div class="header-basket-list-item-content">
            ...
            <ul class="new-list-menu">
                <li class="item-list-menu megamenu-1 category nav-overlay"><a href="#"
                    ...
                    <ul class="list-menu-level-2">
                        ...
                        <li class="item-menu-2"><a href="#" class="list-category-menu-2"><i class="{{$cat->icon}}"></i>{{$cat->title}}</a>

                            <ul class="megamenu-level-3 row">
                                <li class="list-category">
                                    <a href="#" class="list-category-megamenu">همه دسته بندی های {{$cat->title}}</a>
                                </li>
                                @foreach($cat_level2->where('parent_id',$cat->id) as $cat2)
                                <li class="item-megamenu-title"><a href="#"
                                                                   class="list-category-megamenu-3"><span>{{$cat2->title}}<i
                                                class="fa fa-angle-left"></i></span></a></li>
                                @foreach($cat_level3->where('parent_id',$cat2->id) as $cat3)
                                    <li class="item-megamenu-item"><a href="#" class="list-category-megamenu-3">{{$cat3->title}}</a></li>
                                    @endforeach
                                @endforeach
                ...
                <li class="item-list-menu megamenu-1"><a href="#" class="list-category first after"
                                                         style="font-weight: bold;"><i
                            class="mdi mdi-store text-warning"></i> سوپر مارکت</a></li>
    ...
    <nav class="sidebar">
        <div class="nav-header">
            ...
            <div class="logo-wrap">
                <a class="logo-icon" href="#"><img alt="logo-icon" src="{{asset('home/assets/images/logo.png')}}"
                                                   width="40"></a>
            </div>
        </div>
