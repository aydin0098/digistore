        ...
        <div class="sidebar-wrapper">
            <div class="box-sidebar">
                <div class="profile-box" style="border: none;">
                    <img src="{{asset('home/assets/images/profile/1.jpg')}}" class="profile-box-img-banner"
                         alt="profile">
                </div>
            </div>

            @include('livewire.home.includes.profile-sidebar')
        ...
        <div class="col-lg-6 col-xs-12 pull-right">
            ...
            <div class="profile-stats mt-3">
                <div class="profile-recent-fav">
                    <a href="#"><img src="{{asset('home/assets/images/product-slider-2/111472656.jpg')}}" alt="profile"></a>
    ...
    <div class="adplacement pull-right">
        <div class="col-6 col-lg-3 pull-right" style="padding-left:0;">
            <a href="#" class="item-adplacement">
                <img src="{{asset('home/assets/images/post-adplacement/1000012860.jpg')}}" title="صوتی و تصویری"
                     alt="adplacement">
            </a>
        </div>
        ...
        <div class="col-6 col-lg-3 pull-right">
            <a href="#" class="item-adplacement">
                <img src="{{asset('home/assets/images/post-adplacement/1000012872.jpg')}}" title="شوینده ظروف"
                     alt="adplacement">
            </a>
        </div>
        ...
        <div class="col-6 col-lg-3 pull-right" style="padding-left:0;">
            <a href="#" class="item-adplacement">
                <img src="{{asset('home/assets/images/post-adplacement/1000013192.jpg')}}" title="افس"
                     alt="adplacement">
            </a>
        </div>
        ...
        <div class="col-6 col-lg-3 pull-right">
            <a href="#" class="item-adplacement">
                <img src="{{asset('home/assets/images/post-adplacement/1000012909.jpg')}}" title="مراقبت پوست و مو"
                     alt="adplacement">
            </a>
        </div>
    </div>
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                ...
                                <div class="owl-item active" style="width: 315.75px; margin-left: 10px;">
                                    <div class="item">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/product-slider-2/111460776.jpg')}}"
                                                 class="img-fluid"
                                                 alt="img-slider">
                                        </a>
                                        <h2 class="post-title">
                                ...
                                <div class="owl-item active" style="width: 315.75px; margin-left: 10px;">
                                    <div class="item">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/product-slider-2/111474228.jpg')}}"
                                                 class="img-fluid"
                                                 alt="img-slider">
                                        </a>
                                        <h2 class="post-title">
                                ...
                                <div class="owl-item active" style="width: 315.75px; margin-left: 10px;">
                                    <div class="item">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/product-slider-2/112145268.jpg')}}"
                                                 class="img-fluid"
                                                 alt="img-slider">
                                        </a>
                                        <h2 class="post-title">
                                ...
                                <div class="owl-item active" style="width: 315.75px; margin-left: 10px;">
                                    <div class="item">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/product-slider-2/111475300.jpg')}}"
                                                 class="img-fluid"
                                                 alt="img-slider">
                                        </a>
                                        <h2 class="post-title">
                                ...
                                <div class="owl-item" style="width: 315.75px; margin-left: 10px;">
                                    <div class="item">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/product-slider-2/113542184.jpg')}}"
                                                 class="img-fluid"
                                                 alt="img-slider">
                                        </a>
                                        <h2 class="post-title">
                                ...
                                <div class="owl-item" style="width: 315.75px; margin-left: 10px;">
                                    <div class="item">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/product-slider-2/111469793.jpg')}}"
                                                 class="img-fluid"
                                                 alt="img-slider">
                                        </a>
                                        <h2 class="post-title">
                                ...
                                <div class="owl-item" style="width: 315.75px; margin-left: 10px;">
                                    <div class="item">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/product-slider-2/111472656.jpg')}}"
                                                 class="img-fluid"
                                                 alt="img-slider">
                                        </a>
                                        <h2 class="post-title">
